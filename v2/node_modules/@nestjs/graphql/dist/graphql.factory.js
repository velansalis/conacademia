...
let GraphQLFactory = class GraphQLFactory {
    ...
    mergeOptions(options = { typeDefs: [] }) {
        ...
        `,
                    resolverValidationOptions: Object.assign({}, (options.resolverValidationOptions || {}), { requireResolversForResolveType: false }),
                });
                ...
                return Object.assign({}, options, { typeDefs: undefined, schema: yield transformSchema(schema) });
            }
            if (lodash_1.isEmpty(options.typeDefs)) {
                return Object.assign({}, options, { typeDefs: undefined, schema: yield transformSchema(options.schema) });
            }
            const executableSchema = graphql_tools_1.makeExecutableSchema({
                resolvers: extend_util_1.extend(typesResolvers, options.resolvers),
